...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        layoutFlash = findViewById(R.id.layout_flash);
        layoutFlash.setOnClickListener(flashListener);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    if (debugMode){
                        resultIntent.setClass(CaptureActivity.this, ScanDetailActivity.class);
                    ...
                    Toast.makeText(CaptureActivity.this, getString(R.string.identification_of_failure), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            Toast.makeText(CaptureActivity.this, getString(R.string.scan_failed), Toast.LENGTH_SHORT).show();
        } else {
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
...
//            Logger.d("saomiao",resultString);
            resultIntent.putExtras(bundle);
            if (debugMode){
                resultIntent.setClass(this, ScanDetailActivity.class);
                startActivity(resultIntent);
            } else {
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                if(!isSuccess){
                    Toast.makeText(CaptureActivity.this, getString(R.string.cannot_be_turned_on_temporarily), Toast.LENGTH_SHORT).show();
                    return;
                }
                if (isFlashOn) {
                    // 关闭闪光灯
                    layoutFlash.setBackgroundResource(R.drawable.ic_light_off);
                    isFlashOn = false;
                } else {
                    // 开启闪光灯
                    layoutFlash.setBackgroundResource(R.drawable.ic_light_on);
                    isFlashOn = true;
                }
            }catch (Exception e){
                e.printStackTrace();
